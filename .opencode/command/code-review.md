...
Review uncommitted changes by default. If no uncommitted changes, review all commits on the current branch. If the user provides a pull request/merge request number or link, use CLI tools (gh/glab) to fetch it and then perform your review.
